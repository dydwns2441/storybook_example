    ...
    return (
        ...
        >
            <g clip-path="url(#clip0)">
                ...
                />
                <path d="M127.327 0.215179H69.3491V12.621H127.327V0.215179Z" fill="#5467F5" />
                <path
                    ...
                    fill="#5467F5"
                />
                <path d="M52.6508 36.4044H24.271V48.8102H52.6508V36.4044Z" fill="url(#paint1_linear)" />
                <path
                    ...
                    fill="#5467F5"
                />
                <path d="M57.4046 13.2661V48.8104H45.0063V13.2661H57.4046Z" fill="#5467F5" />
                <path
                ...
                <path
                    ...
                    fill="#5467F5"
                />
                <path d="M127.446 0.310837H69.4683V12.7167H127.446V0.310837Z" fill="url(#paint6_linear)" />
                <path d="M135.617 0.215179H123.218V48.8107H135.617V0.215179Z" fill="#5467F5" />
                <path
                ...
                <path d="M231.554 0.215179H222.404V48.5955H231.554V0.215179Z" fill="#5467F5" />
                <path
                    ...
                    fill="#5467F5"
                />
                <path d="M175.51 0.238846V48.5714H166.433V0.238846H175.51Z" fill="#5467F5" />
                <path d="M187.073 0.215179H177.923V48.5955H187.073V0.215179Z" fill="#5467F5" />
                <path
